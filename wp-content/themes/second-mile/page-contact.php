...
<section class="mt-nav min-h-screen bg-black text-white lg:relative">
  <div class="aspect-5:3 hidden lg:block lg:aspect-none lg:absolute lg:pin"><?php echo do_shortcode( '[huge_it_maps id="1"]' ); ?></div>
  <div class="aspect-5:3 lg:hidden"><?php echo do_shortcode( '[huge_it_maps id="2"]' ); ?></div>
    ...
    <div class="lg:w-3/4 lg:mx-auto">
      ...
      <address class="mb-8">
        <p class="roman text-sm mb-4 flex items-center">
          <svg class="mr-3" width="13px" height="auto" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <p class="roman text-sm flex items-center">
          <svg class="mr-3" width="15px" height="auto" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
