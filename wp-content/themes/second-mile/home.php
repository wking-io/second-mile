...
<section id="minstries">
  ...
  <?php if ( have_posts() ) : ?>
    ...
    <?php while ( have_posts() ) : the_post(); ?>
      ...
      ?>
      <li class="w-1/3 bg-cover bg-center text-white" style="background-image: linear-gradient( rgba(<?php echo $color; ?>, 0.83), rgba(<?php echo $color; ?>, 0.83) ), url('<?php echo $bg['sizes']['medium_large']; ?>');">
        <p class="uppercase"><strong><?php echo $category; ?></strong></p>
        <h2><?php the_title(); ?></h2>
        <p><a href="<?php echo $donate_link; ?>">Donate Now</a></p>
      </li>
    <?php endwhile; ?>
    </ul>
  <?php else: ?>
