...
function secondmile_name_shortcode( $atts = array() ) {
	...
	<div class="<?php echo $a['classname']; ?>">
		...
		<svg class="logo-name w-full h-full block" viewBox="0 0 165 20" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<path class="logo-name__fill" d="M27.6228 0.350877H16.5819V19.6491H27.6228V15.7895H20.9795V11.9064H27.3421V8.04678H20.9795V4.21053H27.6228V0.350877Z" fill="<?php echo $color; ?>"/>
			...
			<path class="logo-name__fill" d="M72.6745 7.67251H72.7213L80.3938 19.6491H84.7915V0.350877H80.3938V12.3275H80.347L72.6745 0.350877H68.2769V19.6491H72.6745V7.67251Z" fill="<?php echo $color; ?>"/>
			<path class="logo-name__fill" d="M87.6025 0.350877V19.6491H93.1932C98.5031 19.6491 102.924 15.6257 102.924 9.98831C102.924 4.37427 98.4797 0.350877 93.1932 0.350877H87.6025ZM92.0002 15.7193V4.2807H92.6785C95.9534 4.2807 98.1756 6.78363 98.1756 10.0117C98.1522 13.2398 95.93 15.7193 92.6785 15.7193H92.0002Z" fill="<?php echo $color; ?>"/>
			<path class="logo-name__fill" d="M127.222 19.6491H131.619L129.888 0.350877H125.21L120.929 11.4854L116.649 0.350877H111.97L110.239 19.6491H114.637L115.549 8.21053H115.666L119.619 19.5322H122.239L126.192 8.21053H126.309L127.222 19.6491Z" fill="<?php echo $color; ?>"/>
			<path class="logo-name__fill" d="M137.802 0.350877H133.404V19.6491H137.802V0.350877Z" fill="<?php echo $color; ?>"/>
			<path class="logo-name__fill" d="M144.997 0.350877H140.6V19.6491H151.641V15.7895H144.997V0.350877Z" fill="<?php echo $color; ?>"/>
			<path class="logo-name__fill" d="M164.867 0.350877H153.826V19.6491H164.867V15.7895H158.224V11.9064H164.586V8.04678H158.224V4.21053H164.867V0.350877Z" fill="<?php echo $color; ?>"/>
		</svg>
	</div>
...
function secondmile_logo_shortcode( $atts = array() ) {
	...
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 1080" class="logo-icon <?php echo $a['classname']; ?>">
		<polyline class="logo-name__fill" points="621.27 428.98 714.34 530.1 621.27 631.22 746.72 631.22 746.72 766.9 310.28 766.9 621.27 428.98" fill="<?php echo $color; ?>" />
		<path class="logo-name__fill" d="M621.27,429a71,71,0,1,0-141.9,0H353.92c0-108.46,87.93-196.39,196.4-196.39S746.72,320.52,746.72,429Z" fill="<?php echo $color; ?>" />
		<path class="logo-name__fill" d="M540,1080C242.25,1080,0,837.75,0,540S242.25,0,540,0s540,242.25,540,540S837.76,1080,540,1080Zm0-963.75c-233.65,0-423.75,190.09-423.75,423.75S306.35,963.75,540,963.75,963.75,773.66,963.75,540,773.66,116.25,540,116.25Z" fill="<?php echo $color; ?>" />
	</svg>
